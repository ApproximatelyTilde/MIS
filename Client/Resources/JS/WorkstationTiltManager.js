class WorkstationMotionTilt extends VanillaTilt {
    ...
    HandleFocusLoss() {
        SystemDebugger.LogDebugMessage("Workstation Tilt Target Reset: Focus Lost");
        this.TargetPanX = 0.0;
        this.TargetPanY = 0.0;
        this.TargetTiltX = 0.0;
        this.TargetTiltY = 0.0;
    ...
    HandleFocusGain() {
        SystemDebugger.LogDebugMessage("Workstation Tilt Target Reset: Focus Gained");
        this.TargetPanX = 0.0;
        this.TargetPanY = 0.0;
        this.TargetTiltX = 0.0;
        this.TargetTiltY = 0.0;
    ...
    DisableMotion() {
        if (!this.IsMotionDisabled) {
            ...
            this.TargetTiltX = 0.0;
            this.TargetTiltY = 0.0;
            SystemDebugger.LogDebugMessage("Workstation Tilt Disabled: PanX=" + this.CurrentPanX.toFixed(1) + ", TiltX=" + this.CurrentTiltX.toFixed(1));
        }
    }
    ...
    EnableMotion() {
        if (this.IsMotionDisabled) {
            ...
            this.TargetTiltX = 0.0;
            this.TargetTiltY = 0.0;
            SystemDebugger.LogDebugMessage("Workstation Tilt Enabled");
        }
    }
...
const WorkstationTiltManager = {
    ...
    Initialize: function () {
        ...
        SystemDebugger.LogDebugMessage("Workstation Tilt Initialized: Stage='#WorkstationMotionStage', Max=1.5deg, Perspective=1400px");
    },
