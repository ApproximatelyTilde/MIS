const SystemBootManager = {
    ...
    Initialize: function () {
        SystemDebugger.LogDebugMessage("Initializing System Boot Manager");
    ...
    GetOrCreateStationHardwareAddress: function () {
        ...
        for (let Index = 0; Index < CookieTokens.length; Index++) {
            ...
            if (Token.indexOf(CookiePrefix) === 0) {
                ...
                SystemDebugger.LogDebugMessage("Station Hardware Address Retrieved From Cookie: " + ExistingAddress);
        ...
        SystemDebugger.LogDebugMessage("Station Hardware Address Generated And Assigned: " + AssignedAddress);
        return AssignedAddress;
    },

    PreloadAssets: function () {
        SystemDebugger.LogDebugMessage("Beginning Preload Of System Assets");
        const ImagePaths = [
        ...
        return Promise.allSettled([...ImagePromises, ...FontPromises]).then(() => {
            ...
            SystemDebugger.LogDebugMessage("Completed Preload Of System Assets");
        });
    },

    StartBootSequence: function () {
        SystemDebugger.LogDebugMessage("Starting System Boot Sequence");
        this.IsBooting = true;
    ...
    ExecuteDisplayModeSwitch: function () {
        SystemDebugger.LogDebugMessage("Executing Display Mode Switch");
        const ScreenContainer = $("#DesktopScreenContainer");
    ...
    ExecuteSplashScreenSequence: function () {
        SystemDebugger.LogDebugMessage("Executing Splash Screen Sequence");
    ...
    FinishBootSequence: function () {
        SystemDebugger.LogDebugMessage("Finishing System Boot Sequence");
    ...
    CheckSessionAndProceed: function (CameFromBoot) {
        SystemDebugger.LogDebugMessage("Checking Session And Proceeding With CameFromBoot: " + CameFromBoot);
    ...
    HandleOAuthReturnFlow: function () {
        SystemDebugger.LogDebugMessage("Handling OAuth Return Flow");
    ...
    ShowLoginDialog: function () {
        SystemDebugger.LogDebugMessage("Displaying Login Dialog");
        $(".DesktopWindow").remove();
        $(".DesktopIconBox").remove();
        $("#WindowPlacementGrid").remove();
        $("#DesktopContextMenu").addClass("HiddenElement");
    ...
    UpdateLoginPromptDisplay: function () {
        SystemDebugger.LogDebugMessage("Updating Login Prompt Display");
    ...
    UpdateAvatarDisplay: function () {
        SystemDebugger.LogDebugMessage("Updating Avatar Display");
    ...
    HandleNetworkSignIn: function () {
        SystemDebugger.LogDebugMessage("Handling Network Sign In Request");
        if (this.CurrentAuthenticatedUsername) {
            this.UnlockDesktopEnvironment();
        } else {
    ...
    PerformGuestLogin: function () {
        SystemDebugger.LogDebugMessage("Performing Guest Login Request");
    ...
    UnlockDesktopEnvironment: function () {
        SystemDebugger.LogDebugMessage("Unlocking Desktop Environment");
        this.IsDesktopUnlocked = true;
        sessionStorage.setItem("SessionBootCompleted", "true");
    ...
    RestartSystem: function () {
        SystemDebugger.LogDebugMessage("Triggering System Restart");
        sessionStorage.removeItem("SessionBootCompleted");
        sessionStorage.removeItem("SessionUnlocked");
        this.IsDesktopUnlocked = false;
        $(".DesktopWindow").remove();
    ...
    ExitToTeletype: function () {
        SystemDebugger.LogDebugMessage("Exiting Desktop To Teletype Terminal");
        $("#DesktopContextMenu").addClass("HiddenElement");
        $("#SystemConfirmationModalContainer").addClass("HiddenElement");
        $("#DesktopContainer").addClass("HiddenElement").addClass("InteractionDisabled");
        $("#SystemLoginScreenContainer").addClass("HiddenElement");
    ...
    HandleTeletypeCommand: function (Command) {
        SystemDebugger.LogDebugMessage("Handling Teletype Command: " + Command);
    ...
    ReturnToDesktop: function () {
        SystemDebugger.LogDebugMessage("Returning From Teletype To Desktop");
        $("#EmulatedTeletypeContainer").addClass("HiddenElement");
        this.UnlockDesktopEnvironment();
    },

    Logout: function () {
        SystemDebugger.LogDebugMessage("Logging Out Current User");
        sessionStorage.removeItem("SessionBootCompleted");
        sessionStorage.removeItem("SessionUnlocked");
        localStorage.removeItem("LastAuthenticatedUsername");
        localStorage.removeItem("LastAuthenticatedAvatarURL");
